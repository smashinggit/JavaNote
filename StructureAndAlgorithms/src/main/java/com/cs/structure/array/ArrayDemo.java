 ...
 * 重点一：线性表（Linear List）。线性表就是数据排成像一条线一样的结构。每个线性表上的数据最多只有前和后两个方向
 ...
 * 4.	容器能否完全替代数组?
 * 相比于数组，java中的ArrayList封装了数组的很多操作，并支持动态扩容。一旦超过村塾容量，扩容时比较耗内存，
 * 因为涉及到内存申请和数据搬移。
 * 数组适合的场景：
...
public class ArrayDemo {
    public static void main(String[] args) {
        ...
        array.insert(3, 6);
        array.insert(1, 7);
//        array.insert(1, 7);   //数组已满，没有可插入的位置
        array.printAll();
        System.out.println("删除index为2的值 " + array.delete(2));
        array.printAll();
